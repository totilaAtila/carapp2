...
export default function AdaugaMembru({ databases }) {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4", children: _jsxs(Card, { className: "max-w-[1400px] mx-auto shadow-xl", children: [_jsx(CardHeader, { className: "bg-gradient-to-r from-blue-600 to-blue-700 text-white", children: _jsxs(CardTitle, { className: "flex items-center gap-3 text-2xl", children: [_jsx(UserPlus, { className: "w-8 h-8" }), "Ad\u0103ugare / Modificare Membru"] }) }), _jsxs(CardContent, { className: "p-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 p-4 bg-white rounded-lg border-2 border-blue-200", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-1", children: "Num\u0103r Fi\u0219\u0103" }), _jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", value: nrFisa, onChange: (e) => setNrFisa(e.target.value), disabled: verificat, className: "flex-1 px-3 py-2 border-2 border-slate-300 rounded-md focus:border-blue-500 focus:outline-none disabled:bg-slate-100", placeholder: "Ex: 123" }), _jsx(Button, { onClick: handleVerificaNrFisa, disabled: loading || verificat, className: "bg-blue-600 hover:bg-blue-700", size: "sm", children: loading ? '...' : '🔍' })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-1", children: "Nume \u0219i Prenume" }), _jsx("input", { type: "text", value: nume, onChange: (e) => setNume(e.target.value), disabled: !verificat, className: "w-full px-3 py-2 border-2 border-slate-300 rounded-md focus:border-blue-500 focus:outline-none disabled:bg-slate-100", placeholder: "Ex: Popescu Ion" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-1", children: "Adres\u0103" }), _jsx("input", { type: "text", value: adresa, onChange: (e) => setAdresa(e.target.value), disabled: !verificat, className: "w-full px-3 py-2 border-2 border-slate-300 rounded-md focus:border-blue-500 focus:outline-none disabled:bg-slate-100", placeholder: "Ex: Str. Libert\u0103\u021Bii nr. 10" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-1", children: "Calitate" }), _jsx("input", { type: "text", value: calitate, onChange: (e) => setCalitate(e.target.value), disabled: !verificat, className: "w-full px-3 py-2 border-2 border-slate-300 rounded-md focus:border-blue-500 focus:outline-none disabled:bg-slate-100", placeholder: "Ex: Membru activ" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-1", children: "Data \u00CEnscriere (DD.MM.YYYY)" }), _jsx("input", { type: "text", value: dataInscr, onChange: (e) => setDataInscr(e.target.value), disabled: !verificat, className: "w-full px-3 py-2 border-2 border-slate-300 rounded-md focus:border-blue-500 focus:outline-none disabled:bg-slate-100", placeholder: "Ex: 15.01.2024" })] }), _jsx("div", { className: "flex items-end", children: _jsxs(Button, { onClick: handleReset, variant: "outline", className: "w-full border-2 border-red-500 text-red-600 hover:bg-red-50", children: [_jsx(RotateCcw, { className: "w-4 h-4 mr-2" }), "Reset"] }) })] }), verificat && (_jsxs("div", { className: "mb-6 hidden lg:block", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(AlertCircle, { className: "w-5 h-5 text-blue-600" }), _jsx("h3", { className: "text-lg font-bold text-slate-800", children: membruExistent ? 'Istoric Financiar (Read-Only)' : 'Date Financiare Inițiale' })] }), _jsxs("div", { className: "grid grid-cols-8 gap-2", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-red-700 mb-1 text-center bg-red-100 py-1 rounded", children: "Dob\u00E2nd\u0103" }), _jsx("textarea", { ref: dobandaRef, value: colDobanda, onChange: (e) => setColDobanda(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-red-300 rounded font-mono focus:border-red-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-red-700 mb-1 text-center bg-red-100 py-1 rounded", children: "\u00CEmp. Deb" }), _jsx("textarea", { ref: imprDebRef, value: colImprDeb, onChange: (e) => setColImprDeb(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-red-300 rounded font-mono focus:border-red-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-red-700 mb-1 text-center bg-red-100 py-1 rounded", children: "\u00CEmp. Cred" }), _jsx("textarea", { ref: imprCredRef, value: colImprCred, onChange: (e) => setColImprCred(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-red-300 rounded font-mono focus:border-red-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-red-700 mb-1 text-center bg-red-100 py-1 rounded", children: "\u00CEmp. Sold" }), _jsx("textarea", { ref: imprSoldRef, value: colImprSold, onChange: (e) => setColImprSold(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-red-300 rounded font-mono focus:border-red-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-slate-700 mb-1 text-center bg-slate-200 py-1 rounded", children: "Lun\u0103-An" }), _jsx("textarea", { ref: lunaAnRef, value: colLunaAn, onChange: (e) => setColLunaAn(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-slate-400 rounded font-mono focus:border-slate-600 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "MM.YYYY" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-green-700 mb-1 text-center bg-green-100 py-1 rounded", children: "Dep. Deb" }), _jsx("textarea", { ref: depDebRef, value: colDepDeb, onChange: (e) => setColDepDeb(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-green-300 rounded font-mono focus:border-green-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-green-700 mb-1 text-center bg-green-100 py-1 rounded", children: "Dep. Cred" }), _jsx("textarea", { ref: depCredRef, value: colDepCred, onChange: (e) => setColDepCred(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-green-300 rounded font-mono focus:border-green-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-bold text-green-700 mb-1 text-center bg-green-100 py-1 rounded", children: "Dep. Sold" }), _jsx("textarea", { ref: depSoldRef, value: colDepSold, onChange: (e) => setColDepSold(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "w-full h-64 px-2 py-1 text-sm border-2 border-green-300 rounded font-mono focus:border-green-500 focus:outline-none disabled:bg-slate-100 resize-none", placeholder: "0" })] })] }), membruExistent && (_jsx(Alert, { className: "mt-3 bg-blue-50 border-blue-300", children: _jsxs(AlertDescription, { className: "text-sm text-blue-800", children: ["\u2139\uFE0F Pentru membri existen\u021Bi, istoricul financiar este ", _jsx("strong", { children: "read-only" }), ". Pute\u021Bi modifica doar datele personale (nume, adres\u0103, calitate, dat\u0103 \u00EEnscriere)."] }) }))] })), verificat && (_jsxs("div", { className: "mb-6 lg:hidden", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(AlertCircle, { className: "w-5 h-5 text-blue-600" }), _jsx("h3", { className: "text-lg font-bold text-slate-800", children: membruExistent ? 'Istoric Financiar' : 'Date Financiare Inițiale' })] }), membruExistent ? (
