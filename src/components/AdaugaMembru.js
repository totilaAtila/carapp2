...
export default function AdaugaMembru({ databases }) {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4", children: _jsxs(Card, { className: "max-w-[1400px] mx-auto shadow-xl", children: [_jsx(CardHeader, { className: "bg-gradient-to-r from-blue-600 to-blue-700 text-white", children: _jsxs(CardTitle, { className: "flex items-center gap-3 text-2xl", children: [_jsx(UserPlus, { className: "w-8 h-8" }), "Ad\u0103ugare / Modificare Membru"] }) }), _jsxs(CardContent, { className: "p-6", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 p-4 bg-white rounded-lg border-2 border-blue-200", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Num\u0103r Fi\u0219\u0103" }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Input, { type: "text", value: nrFisa, onChange: (e) => setNrFisa(e.target.value), disabled: verificat, className: "flex-1", placeholder: "Ex: 123" }), _jsx(Button, { onClick: handleVerificaNrFisa, disabled: loading || verificat, className: "bg-blue-600 hover:bg-blue-700 min-h-[44px]", size: "sm", children: loading ? '...' : '🔍' })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Nume \u0219i Prenume" }), _jsx(Input, { type: "text", value: nume, onChange: (e) => setNume(e.target.value), disabled: !verificat, placeholder: "Ex: Popescu Ion" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Adres\u0103" }), _jsx(Input, { type: "text", value: adresa, onChange: (e) => setAdresa(e.target.value), disabled: !verificat, placeholder: "Ex: Str. Libert\u0103\u021Bii nr. 10" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Calitate" }), _jsx(Input, { type: "text", value: calitate, onChange: (e) => setCalitate(e.target.value), disabled: !verificat, placeholder: "Ex: Membru activ" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Data \u00CEnscriere (DD-MM-YYYY)" }), _jsx(Input, { type: "text", value: dataInscr, readOnly: true, className: "bg-slate-100 cursor-not-allowed", placeholder: "Ex: 15-01-2024" })] }), _jsx("div", { className: "flex items-end", children: _jsxs(Button, { onClick: handleReset, variant: "outline", className: "w-full border-2 border-red-500 text-red-600 hover:bg-red-50 min-h-[44px]", children: [_jsx(RotateCcw, { className: "w-4 h-4 mr-2" }), "Reset"] }) })] }), verificat && (_jsxs("div", { className: "mb-6 hidden lg:block", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(AlertCircle, { className: "w-5 h-5 text-blue-600" }), _jsx("h3", { className: "text-lg font-bold text-slate-800", children: membruExistent ? 'Istoric Financiar (Read-Only)' : 'Date Financiare Inițiale' })] }), _jsx(Card, { children: _jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "grid grid-cols-[4fr_1fr_3fr] gap-2", children: [_jsxs("div", { className: "border-[3px] border-red-500 rounded-lg overflow-hidden bg-gradient-to-b from-red-50 to-red-100", children: [_jsx("div", { className: "text-center font-bold text-slate-800 py-2 bg-gradient-to-b from-red-200 to-red-300 border-b-2 border-red-400", children: "Situa\u021Bie \u00CEmprumuturi" }), _jsxs("div", { className: "grid grid-cols-4 gap-px bg-gray-300", children: [_jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Dob\u00E2nd\u0103" }), _jsx("textarea", { ref: dobandaRef, value: colDobanda, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "\u00CEmprumut" }), _jsx("textarea", { ref: imprDebRef, value: colImprDeb, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Rat\u0103 Achitat\u0103" }), _jsx("textarea", { ref: imprCredRef, value: colImprCred, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Sold \u00CEmprumut" }), _jsx("textarea", { ref: imprSoldRef, value: colImprSold, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] })] })] }), _jsxs("div", { className: "border-[3px] border-slate-500 rounded-lg overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100", children: [_jsx("div", { className: "text-center font-bold text-slate-800 py-2 bg-gradient-to-b from-slate-300 to-slate-400 border-b-2 border-slate-500", children: "Dat\u0103" }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Lun\u0103-An" }), _jsx("textarea", { ref: lunaAnRef, value: colLunaAn, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono font-semibold focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "LL-AAAA" })] })] }), _jsxs("div", { className: "border-[3px] border-green-600 rounded-lg overflow-hidden bg-gradient-to-b from-green-50 to-green-100", children: [_jsx("div", { className: "text-center font-bold text-slate-800 py-2 bg-gradient-to-b from-green-200 to-green-300 border-b-2 border-green-500", children: "Situa\u021Bie Depuneri" }), _jsxs("div", { className: "grid grid-cols-3 gap-px bg-gray-300", children: [_jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Cotiza\u021Bie \u270F\uFE0F" }), _jsx("textarea", { ref: depDebRef, value: colDepDeb, onChange: (e) => setColDepDeb(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "h-[400px] overflow-y-auto bg-white px-2 py-1 text-sm font-mono focus:outline-none disabled:bg-slate-100 resize-none border-0", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Retragere" }), _jsx("textarea", { ref: depCredRef, value: colDepCred, readOnly: true, onScroll: handleScroll, className: "h-[400px] overflow-y-auto bg-slate-100 px-2 py-1 text-sm font-mono focus:outline-none resize-none border-0 cursor-not-allowed", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] }), _jsxs("div", { className: "flex flex-col", children: [_jsx("div", { className: "bg-gradient-to-b from-slate-100 to-slate-200 p-2 text-center font-bold text-xs text-slate-800 border-b-2 border-slate-400", children: "Fond Social \u270F\uFE0F" }), _jsx("textarea", { ref: depSoldRef, value: colDepSold, onChange: (e) => setColDepSold(e.target.value), onScroll: handleScroll, disabled: membruExistent, className: "h-[400px] overflow-y-auto bg-white px-2 py-1 text-sm font-mono focus:outline-none disabled:bg-slate-100 resize-none border-0", style: { scrollbarWidth: 'thin' }, placeholder: "0" })] })] })] })] }), _jsxs("div", { className: "mt-2 text-xs text-slate-500 text-center flex items-center justify-center gap-2", children: [_jsx("div", { className: "w-2 h-2 bg-blue-500 rounded-full animate-pulse" }), "Scroll sincronizat \u00EEntre toate coloanele"] })] }) }), membruExistent && (_jsx(Alert, { className: "mt-3 bg-blue-50 border-blue-300", children: _jsxs(AlertDescription, { className: "text-sm text-blue-800", children: ["\u2139\uFE0F Pentru membri existen\u021Bi, istoricul financiar este ", _jsx("strong", { children: "read-only" }), ". Pute\u021Bi modifica doar datele personale (nume, adres\u0103, calitate, dat\u0103 \u00EEnscriere)."] }) }))] })), verificat && (_jsxs("div", { className: "mb-6 lg:hidden", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx(AlertCircle, { className: "w-5 h-5 text-blue-600" }), _jsx("h3", { className: "text-lg font-bold text-slate-800", children: membruExistent ? 'Istoric Financiar' : 'Date Financiare Inițiale' })] }), membruExistent ? (
                                ...
                                _jsxs("div", { className: "space-y-4", children: [_jsx(Card, { className: "bg-red-50 border-red-300", children: _jsxs(CardContent, { className: "p-4 space-y-4", children: [_jsx("h4", { className: "font-bold text-red-700", children: "\u00CEMPRUMUTURI (Read-Only)" }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Dob\u00E2nd\u0103 (RON)" }), _jsx(Input, { type: "text", value: colDobanda, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "\u00CEmprumut Acordat (RON)" }), _jsx(Input, { type: "text", value: colImprDeb, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Rat\u0103 Achitat\u0103 (RON)" }), _jsx(Input, { type: "text", value: colImprCred, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Sold \u00CEmprumut (RON)" }), _jsx(Input, { type: "text", value: colImprSold, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "0" })] })] }) }), _jsx(Card, { className: "bg-slate-50 border-slate-300", children: _jsxs(CardContent, { className: "p-4 space-y-4", children: [_jsx("h4", { className: "font-bold text-slate-700", children: "DAT\u0102" }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Lun\u0103-An (LL-AAAA)" }), _jsx(Input, { type: "text", value: colLunaAn, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "LL-AAAA" })] })] }) }), _jsx(Card, { className: "bg-green-50 border-green-300", children: _jsxs(CardContent, { className: "p-4 space-y-4", children: [_jsx("h4", { className: "font-bold text-green-700", children: "DEPUNERI" }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Cotiza\u021Bie (RON) \u270F\uFE0F" }), _jsx(Input, { type: "text", value: colDepDeb, onChange: (e) => setColDepDeb(e.target.value), className: "font-mono", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Retragere (RON)" }), _jsx(Input, { type: "text", value: colDepCred, readOnly: true, className: "font-mono bg-slate-100 cursor-not-allowed", placeholder: "0" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-semibold text-slate-700 mb-2", children: "Fond Social (RON) \u270F\uFE0F" }), _jsx(Input, { type: "text", value: colDepSold, onChange: (e) => setColDepSold(e.target.value), className: "font-mono", placeholder: "0" })] })] }) })] }))] })), verificat && (_jsx("div", { className: "flex gap-4 mb-6", children: _jsxs(Button, { onClick: handleSalveaza, disabled: loading, className: "flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 min-h-[44px]", children: [_jsx(Check, { className: "w-5 h-5 mr-2" }), membruExistent ? 'Salvează Modificări' : 'Salvează Membru Nou'] }) })), logs.length > 0 && (_jsx("div", { className: "bg-slate-900 text-green-400 p-4 rounded-lg font-mono text-sm max-h-64 overflow-y-auto", children: logs.map((log, idx) => (_jsx("div", { className: "leading-relaxed", children: log }, idx))) }))] })] }) }));
}
