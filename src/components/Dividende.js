...
export default function Dividende({ databases, onBack }) {
    ...
    const handleCalculateBenefits = () => {
        ...
        try {
            ...
            let lichidatiDB;
            try {
                lichidatiDB = getActiveDB(databases, 'lichidati');
      ...
      `;
            ...
            const result = calculateBenefits(membriiDB, depcredDB, activiDB, selectedYear, profitP, lichidatiDB);
