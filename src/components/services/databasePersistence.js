 ...
 */
export function persistDatabase(db, name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const idb = yield getDB();
            const tx = idb.transaction(STORE_NAME, 'readwrite');
            yield tx.objectStore(STORE_NAME).put(record);
            yield tx.done;
 ...
 */
export function loadPersistedDatabase(name, sql) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const db = yield getDB();
            const record = yield db.get(STORE_NAME, name);
            if (!record) {
 ...
 */
export function checkPersistedDatabases() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const db = yield getDB();
            const keys = yield db.getAllKeys(STORE_NAME);
            return {
                exists: keys,
                total: keys.length
            };
 ...
 */
export function deletePersistedDatabase(name) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const db = yield getDB();
            yield db.delete(STORE_NAME, name);
 ...
 */
export function generateDatabaseName(base, year, month) {
