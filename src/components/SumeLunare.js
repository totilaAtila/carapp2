...
function DesktopHistoryView({ istoric, scrollRefs, formatCurrency, formatLunaAn }) {
    ...
    return (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Istoric Financiar (Desktop View)" }) }), _jsxs(CardContent, { children: [_jsxs("div", { className: "grid grid-cols-8 gap-2", children: [_jsxs("div", { className: "col-span-4 border-r-2 border-blue-300 pr-2", children: [_jsx("div", { className: "text-center font-bold text-blue-800 mb-2 text-sm", children: "\u00CEMPRUMUTURI" }), _jsx("div", { className: "grid grid-cols-4 gap-1", children: columns.slice(0, 4).map((col, idx) => (_jsxs("div", { children: [_jsx("div", { className: "bg-blue-100 p-2 text-center font-semibold text-xs border border-blue-300 rounded-t", children: col.title }), _jsx(ScrollArea, { className: "h-[400px] border border-blue-300 rounded-b", ref: (el) => { scrollRefs.current[idx] = el; }, onScroll: () => handleScroll(idx), children: _jsx("div", { className: "divide-y divide-slate-200", children: istoric.map((tranz, tranzIdx) => {
                                                        ...
                                                        return (_jsx("div", { className: `p-2 text-center text-sm hover:bg-green-50 ${className}`, children: display }, `${tranz.anul}-${tranz.luna}-${tranzIdx}`));
