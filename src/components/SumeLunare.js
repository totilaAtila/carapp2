...
function DesktopHistoryView({ istoric, scrollRefs, formatCurrency, formatLunaAn }) {
    ...
    return (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Istoric Financiar (Desktop View)" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "grid grid-cols-8 gap-2", children: [_jsxs("div", { className: "col-span-4 border-r-2 border-blue-300 pr-2", children: [_jsx("div", { className: "text-center font-bold text-blue-800 mb-2 text-sm", children: "\u00CEMPRUMUTURI" }), _jsx("div", { className: "grid grid-cols-4 gap-1", children: columns.slice(0, 4).map((col, idx) => (_jsxs("div", { children: [_jsx("div", { className: "bg-blue-100 p-2 text-center font-semibold text-xs border border-blue-300 rounded-t", children: col.title }), _jsx(ScrollArea, { className: "h-[400px] border border-blue-300 rounded-b", ref: (el) => { scrollRefs.current[idx] = el; }, onScroll: () => handleScroll(idx), children: _jsx("div", { className: "divide-y divide-slate-200", children: istoric.map((tranz, i) => (_jsx("div", { className: "p-2 text-center text-sm hover:bg-blue-50", children: getValue(tranz, col.key) }, `${tranz.anul}-${tranz.luna}-${i}`))) }) })] }, col.key))) })] }), _jsxs("div", { className: "col-span-1 border-r-2 border-green-300 pr-2", children: [_jsx("div", { className: "text-center font-bold text-green-800 mb-2 text-sm", children: "DAT\u0102" }), _jsxs("div", { children: [_jsx("div", { className: "bg-green-100 p-2 text-center font-semibold text-xs border border-green-300 rounded-t", children: columns[4].title }), _jsx(ScrollArea, { className: "h-[400px] border border-green-300 rounded-b", ref: (el) => { scrollRefs.current[4] = el; }, onScroll: () => handleScroll(4), children: _jsx("div", { className: "divide-y divide-slate-200", children: istoric.map((tranz, i) => (_jsx("div", { className: "p-2 text-center text-sm font-semibold hover:bg-green-50", children: getValue(tranz, columns[4].key) }, `${tranz.anul}-${tranz.luna}-${i}`))) }) })] })] }), _jsxs("div", { className: "col-span-3", children: [_jsx("div", { className: "text-center font-bold text-purple-800 mb-2 text-sm", children: "DEPUNERI" }), _jsx("div", { className: "grid grid-cols-3 gap-1", children: columns.slice(5, 8).map((col, idx) => (_jsxs("div", { children: [_jsx("div", { className: "bg-purple-100 p-2 text-center font-semibold text-xs border border-purple-300 rounded-t", children: col.title }), _jsx(ScrollArea, { className: "h-[400px] border border-purple-300 rounded-b", ref: (el) => { scrollRefs.current[idx + 5] = el; }, onScroll: () => handleScroll(idx + 5), children: _jsx("div", { className: "divide-y divide-slate-200", children: istoric.map((tranz, i) => (_jsx("div", { className: "p-2 text-center text-sm hover:bg-purple-50", children: getValue(tranz, col.key) }, `${tranz.anul}-${tranz.luna}-${i}`))) }) })] }, col.key))) })] })] }) })] }));
}
function MobileHistoryView({ istoric, formatCurrency, formatLunaAn }) {
    return (_jsxs("div", { className: "space-y-4", children: [_jsx("h2", { className: "text-xl font-bold text-slate-800", children: "Istoric Financiar" }), istoric.map((tranz, idx) => (_jsxs(Card, { className: "shadow-md", children: [_jsx(CardHeader, { className: "pb-3", children: _jsxs(CardTitle, { className: "text-lg flex items-center justify-between", children: [_jsx("span", { children: formatLunaAn(tranz.luna, tranz.anul) }), _jsxs("span", { className: "text-sm font-normal text-slate-500", children: [MONTHS[tranz.luna - 1], " ", tranz.anul] })] }) }), _jsx(CardContent, { children: _jsxs(Tabs, { defaultValue: "imprumuturi", className: "w-full", children: [_jsxs(TabsList, { className: "grid w-full grid-cols-2", children: [_jsx(TabsTrigger, { value: "imprumuturi", children: "\u00CEmprumuturi" }), _jsx(TabsTrigger, { value: "depuneri", children: "Depuneri" })] }), _jsx(TabsContent, { value: "imprumuturi", className: "space-y-2 mt-4", children: _jsxs("div", { className: "grid grid-cols-2 gap-2 text-sm", children: [_jsx("div", { className: "font-semibold", children: "Dob\u00E2nd\u0103:" }), _jsxs("div", { className: "text-right", children: [formatCurrency(tranz.dobanda), " RON"] }), _jsx("div", { className: "font-semibold", children: "\u00CEmprumut:" }), _jsxs("div", { className: "text-right", children: [formatCurrency(tranz.impr_deb), " RON"] }), _jsx("div", { className: "font-semibold", children: "Rat\u0103 Achitat\u0103:" }), _jsxs("div", { className: "text-right", children: [formatCurrency(tranz.impr_cred), " RON"] }), _jsx("div", { className: "font-semibold text-blue-700", children: "Sold \u00CEmprumut:" }), _jsxs("div", { className: "text-right font-bold text-blue-700", children: [formatCurrency(tranz.impr_sold), " RON"] })] }) }), _jsx(TabsContent, { value: "depuneri", className: "space-y-2 mt-4", children: _jsxs("div", { className: "grid grid-cols-2 gap-2 text-sm", children: [_jsx("div", { className: "font-semibold", children: "Cotiza\u021Bie:" }), _jsxs("div", { className: "text-right", children: [formatCurrency(tranz.dep_deb), " RON"] }), _jsx("div", { className: "font-semibold", children: "Retragere:" }), _jsxs("div", { className: "text-right", children: [formatCurrency(tranz.dep_cred), " RON"] }), _jsx("div", { className: "font-semibold text-purple-700", children: "Sold Depuneri:" }), _jsxs("div", { className: "text-right font-bold text-purple-700", children: [formatCurrency(tranz.dep_sold), " RON"] })] }) })] }) })] }, `${tranz.anul}-${tranz.luna}-${idx}`)))] }));
}
