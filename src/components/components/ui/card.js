...
const Card = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement("div", Object.assign({ ref: ref, className: cn("rounded-xl border border-slate-200 bg-white text-slate-950 shadow", className) }, props)));
});
...
const CardDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement("div", Object.assign({ ref: ref, className: cn("text-sm text-slate-500", className) }, props)));
});
