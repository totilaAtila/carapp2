...
export default function App() {
    ...
    // --- Main App State ---
    return (_jsxs("div", { className: "relative min-h-screen bg-slate-100", children: [_jsx("main", { role: "main", className: "min-h-screen pb-[60px]", children: _jsxs("div", { className: "w-full h-full p-4 md:p-6", children: [currentModule === 'generare-luna' && databases && (_jsx(GenerareLuna, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'vizualizare-lunara' && databases && (_jsx(VizualizareLunara, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'vizualizare-anuala' && databases && (_jsx(VizualizareAnuala, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'vizualizare-trimestriala' && databases && (_jsx(VizualizareTrimestriala, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'sume-lunare' && databases && (_jsx(SumeLunare, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'calculeaza-dobanda' && databases && (_jsx(CalculeazaDobanda, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'adauga-membru' && databases && (_jsx(AdaugaMembru, { databases: databases })), currentModule === 'sterge-membru' && databases && (_jsx(StergeMembru, { databases: databases })), currentModule === 'lichidati' && databases && (_jsx(Lichidati, { databases: databases })), currentModule === 'dashboard' && databases && (_jsx(Dashboard, { databases: databases, onModuleSelect: (module) => setCurrentModule(module), onChangeDatabaseSource: handleChangeDatabaseSource })), currentModule === 'dividende' && databases && (_jsx(Dividende, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'statistici' && databases && (_jsx(Statistici, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'listari' && databases && (_jsx(Listari, { databases: databases, onBack: () => setCurrentModule('dashboard') })), currentModule === 'conversion' && databases && (_jsx(Conversion, { databases: databases, onBack: () => setCurrentModule('dashboard') })), databases && ![
                            'dashboard',
                            'calculeaza-dobanda',
                            'generare-luna',
                            'vizualizare-lunara',
