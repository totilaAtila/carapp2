 ...
 */
export async function clearAllPersistedDatabases() {
    try {
 ...
 */
export async function persistDatabase(db, name) {
    try {
 ...
 */
export async function loadPersistedDatabase(name, sql) {
    try {
        const db = await getDB();
 ...
 */
export async function checkPersistedDatabases() {
    try {
        const db = await getDB();
 ...
 */
export async function deletePersistedDatabase(name) {
    try {
        const db = await getDB();
